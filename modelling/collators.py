...
@dataclass
class DataCollatorForPreciseLanguageModeling(DataCollatorMixin):
    """
    Data collator used for language modeling. Inputs are dynamically padded to the maximum length of a batch if they
    are not all of the same length.
    Will only mask tokens in the training sentence that have learnable senses i.e. have sense-keys
